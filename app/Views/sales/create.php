...
<body class="main-bg main-bg-opac main-bg-blur roundedui adminuiux-header-standard adminuiux-sidebar-standard adminuiux-mobile-footer-fill-theme adminuiux-header-transparent theme-pista bg-r-gradient adminuiux-sidebar-fill-none scrollup" data-theme="theme-pista" data-sidebarfill="adminuiux-sidebar-fill-none" data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true" tabindex="0" data-sidebarlayout="adminuiux-sidebar-standard"
    ...
    <div class="adminuiux-wrap">
        <main class="adminuiux-content">
            ...
            <?php if ($product->product_type == "fee_transfer") { ?>
                <form id="myForm" action="<?= base_url('sales/store_fee_transfer') ?>" method="post" enctype="multipart/form-data" class="form-harga">
                    ...
                    <div class="card bg-none mb-3 mb-lg-4">
                        <div class="card-body pb-0">
                            <div class="row gx-3 gx-lg-4">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" placeholder="Nominal" type="text" id="base_price" name="base_price" oninput="formatHargaDanHitungFee()" required>
                                        <label>Nominal</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="text" name="admin_fee" id="fee">
            ...
            <?php } else if ($product->product_type == "fee_fixed") { ?>
                <form id="myForm" action="<?= base_url('sales/store_fee_fixed') ?>" method="post" enctype="multipart/form-data" class="form-harga">
                    <div class="card bg-none mb-3 mb-lg-4">
                        <div class="card-body pb-0">
                            <div class="row gx-3 gx-lg-4">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="text" name="selling_price" value="<?= $product->qty ?>" readonly>
                                        <label>Stok</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="text" name="selling_price" value="<?= 'Rp. ' . number_format($product->selling_price, 0, ',', '.'); ?>" readonly>
                    ...
                    <div class="card bg-none mb-3 mb-lg-4">
                        <div class="card-body pb-0">
                            <div class="row gx-3 gx-lg-4">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" placeholder="Quantity" type="number" min="1" max="<?= $product->qty ?>" name="qty_order" value="1" required>
                                        <label>Jumlah Jual</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control format-rupiah-discount" type="text" name="discount">
                                        <label>Diskon</label>
                                    </div>
                                </div>
                                <div class="col-12">
            ...
            <?php } else if ($product->product_type == "fee_package") { ?>
                <form id="myForm" action="<?= base_url('sales/store_fee_package') ?>" method="post" enctype="multipart/form-data" class="form-harga">
                    <div class="card bg-none mb-3 mb-lg-4">
                        <div class="card-body pb-0">
                            <div class="row gx-3 gx-lg-4">
                                <div class="col-12">
                    ...
                    <div class="card bg-none mb-3 mb-lg-4">
                        <div class="card-body pb-0">
                            <div class="row gx-3 gx-lg-4">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control format-rupiah-selling" type="text" name="selling_price" required>
                                        <label>Harga Jual</label>
                                    </div>
                                </div>
                                <div class="col-12">
