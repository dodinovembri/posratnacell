                        ...
                        <?php foreach ($balances as $key => $value) { ?>
                            <tr>
                                ...
                                <td><!-- Tombol untuk memicu modal -->
                                    <button type="button" class="btn btn-primary openModalBtn" data-id="<?= $value->id ?>" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $value->id; ?>">
                                        Edit
                                    </button>

                                    <!-- Modal -->

                                    <form action="<?= base_url('balance/update_close/' . $value->id) ?>" method="post" enctype="multipart/form-data" class="form-harga">
