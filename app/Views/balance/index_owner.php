			...
			<div class="container mt-3 mt-lg-4 mt-xl-5" id="main-content">
				<div class="row gx-3">
					...
					<div class="col-6 col-sm-6 col-lg-6 mb-3">
						<a href="<?= base_url('balance/melati') ?>" class="card adminuiux-card shadow-sm style-none">
							<div class="card-body">
								<div class="row gx-3">
									<div class="col">
										<p>Saldo Melati</p>
					...
					<div class="col-6 col-sm-6 col-lg-6 mb-3">
						<a href="<?= base_url('balance/srengseng') ?>" class="card adminuiux-card shadow-sm style-none">
							<div class="card-body">
								<div class="row gx-3">
									<div class="col">
										<p>Saldo Srengseng</p>
