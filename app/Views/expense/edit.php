            ...
            <div class="card bg-none mb-3 mb-lg-4">
                <div class="card-body pb-0">
                    <div class="row gx-3 gx-lg-4">
                        <form id="myForm" action="<?= base_url('expense/update/' . $expense->id) ?>" method="post" enctype="multipart/form-data">
                            <div class="col-12">
                                <h6 class="mb-3">Buat Pengeluaran</h6>
                            </div>
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input class="form-control" placeholder="Masukkan Keterangan" type="text" name="description" value="<?= $expense->description ?>" required>
                                    <label>Keterangan</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input class="form-control" placeholder="Nominal" id="harga" type="text" name="amount" oninput="formatRupiah(this)" value="<?= $expense->amount ?>" required>
                                    <label>Nominal</label>
                                </div>
                            </div>
                            <div class="col-12">
