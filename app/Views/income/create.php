            ...
            <div class="card bg-none mb-3 mb-lg-4">
                <div class="card-body pb-0">
                    <div class="row gx-3 gx-lg-4">
                        <form id="myForm" action="<?= base_url('income/store') ?>" method="post" enctype="multipart/form-data">
                            <div class="col-12">
                                <h6 class="mb-3">Buat Pemasukan</h6>
                            </div>
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input class="form-control" placeholder="Masukkan Keterangan" type="text" name="description" required>
                                    <label>Keterangan</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input class="form-control" placeholder="Nominal" id="harga" type="text" name="amount" oninput="formatRupiah(this)" required>
                                    <label>Nominal</label>
                                </div>
                            </div>
                            <div class="col-12">
